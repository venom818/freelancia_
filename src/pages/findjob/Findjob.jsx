  ...
  return (
    <div>
      <div className="findjob-header">
        <h1 className="findjob-title">Find Jobs</h1>
        <p className="findjob-subtitle">Discover amazing projects that match your skills</p>
      </div>
      ...
      <div className="job-list">
        {filteredJobs.map((job) => (
          <div key={job.id} className="job-card">
            ...
            <button onClick={() => handlePlaceBid(job)}>
              Place Bid
            </button>
          </div>
        ))}
      ...
      {showBidModal && selectedJob && (
        <div className="modal" onClick={() => setShowBidModal(false)}>
          <div onClick={e => e.stopPropagation()}>
            <h2>Submit Proposal</h2>
            <button type="button" className="close-btn" onClick={() => setShowBidModal(false)}>X</button>
            <form onSubmit={e => handleSubmitProposal(e, selectedJob)}>
              {/* Bid Amount Section */}
              <div className="bidding-section">
                <Label className="form-label">Your Bid Amount</Label>
                <div className="bid-input-container">
              ...
              {/* Timeline */}
              <div className="form-group">
                <Label className="form-label" htmlFor="timeline-select">Project Timeline</Label>
                <select
                  id="timeline-select"
